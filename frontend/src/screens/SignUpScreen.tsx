...
export default function SignUpScreen({ onSignUpSuccess, onBackToLogin }: SignUpScreenProps) {
  ...
  return (
    ...
    >
      ...
      <TouchableOpacity onPress={onBackToLogin} style={styles.backButton} activeOpacity={0.7}>
      ...
      {/* Fixed Sign In Option (Middle Bottom) */}
      <View style={styles.signInRow}>
        <Text style={styles.signInText}>Already have a profile? </Text>
